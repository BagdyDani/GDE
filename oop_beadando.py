...
class EgyagyasSzoba(Szoba):
    def __init__(self, szobsz, color):
        super().__init__(szobsz, 60000)
        self.color = color

class KetagyasSzoba(Szoba):
    def __init__(self, szobsz, extra):
        super().__init__(szobsz, 85000)
        self.extra = extra
...
hotel = Szalloda("Vacancy Hotel")

# Rendszer feltöltés: Szobák hozzáadása
hotel.add_szoba(EgyagyasSzoba("101","Fehér"))
hotel.add_szoba(EgyagyasSzoba("105","Zöld"))
hotel.add_szoba(KetagyasSzoba("202","Erkély"))

# Rendszer feltöltés: Foglalások hozzáadása
hotel.fgs("101", datetime(2024, 5, 25))
hotel.fgs("105", datetime(2024, 5, 27))
hotel.fgs("202", datetime(2024, 5, 28))
hotel.fgs("101", datetime(2024, 5, 28))
hotel.fgs("105", datetime(2024, 5, 28))
...
while True:
    ...
    if case == "1":
        szobsz = input("\nAdd meg a foglalandó szobaszámát: ")
        ...
        try:
            ...
            if datum < datetime.now():
                ...
                if ar:
                    print(f"Sikeres foglalás! Az ár: {ar} Ft")
                else:
                    print("\nHibás szobaszám!")
                    winsound.PlaySound("SystemExclamation", winsound.SND_ALIAS)
        except ValueError:
        ...
        szobsz = input("\nAdd meg a lemondandó foglalás szobaszámát: ")
        ...
        hotel.list_fgs_ok()
            ...
            for szoba in hotel.szobak:
                if isinstance(szoba, EgyagyasSzoba):
                    print(f"Szobaszám: {szoba.szobsz}, Ár: {szoba.ar} Ft, (Szín: {szoba.color})")
            print("\nKétágyas szobák:")
            for szoba in hotel.szobak:
